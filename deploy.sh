...
ssh $SERVER_USER@$SERVER_ADDRESS <<- EOF
  ...
  export REACT_APP_JORDAN_LOCALSTORAGE_KEY=$REACT_APP_JORDAN_LOCALSTORAGE_KEY
  export REACT_APP_JORDAN_LOCALSTORAGE_TIMESTAMP_KEY=$REACT_APP_JORDAN_LOCALSTORAGE_TIMESTAMP_KEY
  export REACT_APP_JORDAN_PASSWORD=$REACT_APP_JORDAN_PASSWORD
EOF
