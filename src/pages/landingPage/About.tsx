    ...
    <>
      ...
      <HubContentContainer>
        <Root>
          ...
          <h2>Team</h2>
          <Content>
            Viz Hub projects are built in-house by the Growth Lab’s Digital Development & Design Team.  We are:
          </Content>

          <Content>
            <a href='https://growthlab.cid.harvard.edu/people/annie-white'>Annie White</a> Senior Software Product Manager<br />
            Annie oversees the strategy and creation of all Viz Hub projects, from research to design, development and launch. She is interested in the application of software tools to positively impact economic development, equity, and the public interest.
          </Content>

          <Content>
            <a href='http://bleonard.io/'>Brendan Leonard</a> Back-End and Data Developer<br />
            Brendan leads the implementation of back-end technologies and data analysis for Viz Hub projects. He is interested in the way modern technology influences democratic systems and is completing his master’s degree in the field of government.
          </Content>

          <Content>
            <a href='http://www.niltuzcu.net/'>Nil Tuzcu</a> UX/UI &amp; Data Visualization Designer<br />
            Nil leads the design vision of Viz Hub projects, encompassing data visualization design, prototype development,  and user research.
          </Content>

          <Content>
            <a href='https://www.soeltz.com/'>Kyle Soeltz</a> Front-End Web Developer<br />
            Kyle leads the implementation of front-end technologies for all user interfaces and data visualizations across Viz Hub projects. He is interested in how powerful online tools that make education and resources more accessible can help better societies. Before he started at the Growth Lab, Kyle led the front-end development of an education technology startup and in between these two jobs he spent 6 months hiking the Pacific Crest Trail while raising money and awareness for mental health research.
          </Content>
