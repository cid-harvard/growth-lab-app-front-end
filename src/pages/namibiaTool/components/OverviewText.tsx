...
const OverviewText = () => {
  ...
  const dropdownLine = (productClass === ProductClass.HS)
    ...
    : 'Users can choose any of 363 industries (based on NAICS industry codes at the 6-digit level) from the above drop-down list and explore the industry’s match with Namibia’s current productive capabilities and comparative advantages and disadvantages.';
  return (
  <>
     <p>
     ...
     <p>
        Harvard Growth Lab <a href='https://growthlab.hks.harvard.edu/applied-research/namibia' target='_blank' rel='noopener noreferrer'>research</a> in Namibia shows that the long-term rate of economic growth will be determined by the pace at which the country can develop new economic activities and attract skills and investment from abroad. Detailed information on the methodology and data sources used in this tool can be found <a href='https://docs.google.com/document/d/1WUDKvL4g-Rt9v2SN_womLlGJ5ABpLz4EglXlcTjkCPo/edit?usp=sharing' target='_blank' rel='noopener noreferrer'>here</a>. This tool can be used in combination with the Growth Lab’s <a href='https://atlas.hks.harvard.edu/explore/treemap?exporter=country-516' target='_blank' rel='noopener noreferrer'>Atlas of Economic Complexity</a> and the <a href='https://metroverse.hks.harvard.edu/' target='_blank' rel='noopener noreferrer'>Metroverse</a> to explore patterns in global trade in very high detail and city-level analytics of productive capabilities.
     </p>
   </>
  );
};
